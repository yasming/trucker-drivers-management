...
# well-known key for local development (DEBUG=True).
...
if not SECRET_KEY:
    ...
    SECRET_KEY = "django-insecure-ygn@m@7*e-**+cau+o_bm(%&34p&48@g5v8qg=iz$)lsa0#^nu"
...
# This app stores planned trips in process memory and does not require a
